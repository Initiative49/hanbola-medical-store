...
document.addEventListener("DOMContentLoaded",()=>{updateCartCount();let nav=document.getElementById("mainNav"),mb=document.getElementById("mobileMenuBtn");if(mb&&nav)mb.onclick=()=>nav.classList.toggle("open");
